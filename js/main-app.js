    ...
    app.ports.loadNotes.subscribe(function () {
        loadNotesFromDB()
            .then(async notes => {
                ...
                // Auto-load last note during startup if conditions are met
                // Check if this is likely a startup scenario
                ...
                if (isStartupContext && notes.length > 0) {
                    console.log('🔍 Auto-loading last note during startup context');
